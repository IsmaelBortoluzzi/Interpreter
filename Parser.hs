...
happyExpList = Happy_Data_Array.listArray (0,290) ([4128,2407,64,0,0,0,65280,19263,512,38513,0,0,0,0,4096,45960,4,0,0,16384,32768,40000,37,0,1,0,64,65532,364,0,8192,65520,1207,58304,0,0,0,16512,9628,33024,19256,512,38513,1024,11490,2049,22980,4098,45960,8196,26384,16393,52768,32786,40000,37,30,0,60,0,120,0,15856,0,31200,0,0,0,0,0,3072,0,6144,0,512,38513,0,8192,12,0,4096,45960,57348,26623,25,0,1,0,388,0,0,0,0,65532,302,50184,601,0,64,4128,2407,8256,4814,0,0,0,0,0,4096,6,0,0,32768,0,0,0,0
	])
...
action_27 (14) = happyFail []
action_27 (15) = happyFail []
action_27 (16) = happyFail []
...
action_28 (14) = happyFail []
action_28 (15) = happyFail []
action_28 (16) = happyFail []
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenOr -> cont 12;
	TokenNot -> cont 13;
	TokenGreater -> cont 14;
	TokenSmaller -> cont 15;
	TokenEqual -> cont 16;
	TokenTrue -> cont 17;
	TokenFalse -> cont 18;
	TokenIf -> cont 19;
